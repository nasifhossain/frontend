...
import { ArrowLeft, Calendar, User, FileText, Image, Plus } from 'lucide-react';
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                You haven't created any posts yet. Start sharing your thoughts and ideas with the community!
              </p>
              <Button 
                onClick={() => router.push('/')} 
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900">
                Your Posts ({pagination?.totalPosts || posts.length})
              </h2>
            </div>
